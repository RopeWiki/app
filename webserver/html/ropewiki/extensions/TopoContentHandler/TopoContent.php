...
class TopoContent extends \TextContent {
	public function __construct( $text, $model_id = CONTENT_MODEL_TOPO_DATA ) {
	...
	public function getHtml() {
        ...
        "This is the configuration used to make canyon topos, it's not intended to be edited by hand.\n".
		"<br>".
		"<a href='/topo/?rw=Topo:" . RequestContext::getMain()->getTitle()->getText() . "'>Interactive Editor</a>".
        ...
        "<script>let raw = `".$this->getNativeData()."`;\n window.addEventListener('load', quick_draw(raw));\n </script>\n";
