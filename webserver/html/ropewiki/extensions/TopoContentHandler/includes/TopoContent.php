...
class TopoContent extends \TextContent {
    ...
    public function getParserOutput( Title $title,
        ...
        if ( $generateHtml ) {
            ...
            $po->addHeadItem( '<script src="/topo/redux/deps/js-yaml.min.js"></script>', 'topo-js-yaml' );
            $po->addHeadItem( '<script src="/topo/redux/lib/renderer.js"></script>', 'topo-renderer' );
            $po->addHeadItem( '<script src="/topo/redux/lib/viewer.js"></script>', 'topo-viewer' );
            $po->addHeadItem( '<link rel="stylesheet" href="/topo/redux/style.css" />', 'topo-style' );
